...
import static com.pdftools.utils.Constants.ADD_PASSWORD;
import static com.pdftools.utils.Constants.ADD_WATERMARK;
import static com.pdftools.utils.Constants.REMOVE_PASSWORD;
import static com.pdftools.utils.Constants.ROTATE_PAGES;
...
public class DialogUtils {
    ...
    public MaterialDialog createAnimationDialog(Activity activity) {
        return new MaterialDialog.Builder(activity).customView(R.layout.lottie_anim_dialog, false)
                .build();
    }
