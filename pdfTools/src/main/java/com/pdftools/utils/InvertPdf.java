...
public class InvertPdf extends AsyncTask<Void, Void, Void> {
    ...
    private String mPath, outputPath;
     ...
     */
    public InvertPdf(String path, String outputPath, OnPDFCreatedInterface onPDFCreatedInterface) {
        this.mPath = path;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            if (fileDescriptor != null) {
                String outputPath = this.outputPath + "/" + System.currentTimeMillis() + "_inverted.pdf";//.replace(".pdf", "_inverted" + pdfExtension);
