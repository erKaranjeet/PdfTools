...
import static com.pdftools.utils.FileUtils.getFileNameWithoutExtension;
import static com.pdftools.utils.FileUtils.saveImage;
        ...
        try {
            ...
            if (fileDescriptor != null) {
                ...
                for (int i = 0; i < pageCount; i++) {
                    ...
                    // generate numbered image file names               getFileNameWithoutExtension(mPath)
                    String filename = System.currentTimeMillis() +
                            "_" + (i + 1);
                    String path = saveImage(mContext, filename, bitmap);
                    if (path != null) {
